...
public class ListIssuesData implements Bean {
    ...
    /**
     * Sets the assigneeEmail.
     * @param assigneeEmail  the new value of the property
     */
    ...
    /**
     * Gets the the {@code assigneeEmail} property.
     * @return the property, not null
     */
    public final Property<String> assigneeEmail() {
        return metaBean().assigneeEmail().createProperty(this);
    }
    ...
    /**
     * Sets the assigneeId.
     * @param assigneeId  the new value of the property
     */
    ...
    /**
     * Gets the the {@code assigneeId} property.
     * @return the property, not null
     */
    public final Property<Long> assigneeId() {
        return metaBean().assigneeId().createProperty(this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && obj.getClass() == this.getClass()) {
            ...
            return JodaBeanUtils.equal(getId(), other.getId()) &&
                    ...
                    JodaBeanUtils.equal(getAssigneeEmail(), other.getAssigneeEmail()) &&
                    (getAssigneeId() == other.getAssigneeId()) &&
    ...
    public int hashCode() {
        ...
        hash = hash * 31 + JodaBeanUtils.hashCode(getAssigneeEmail());
        hash = hash * 31 + JodaBeanUtils.hashCode(getAssigneeId());
    ...
    protected void toString(StringBuilder buf) {
        ...
        buf.append("assigneeEmail").append('=').append(JodaBeanUtils.toString(getAssigneeEmail())).append(',').append(' ');
        buf.append("assigneeId").append('=').append(JodaBeanUtils.toString(getAssigneeId())).append(',').append(' ');
    ...
    public static class Meta extends DirectMetaBean {
        ...
        /**
         * The meta-property for the {@code assigneeEmail} property.
         */
        private final MetaProperty<String> assigneeEmail = DirectMetaProperty.ofReadWrite(
                this, "assigneeEmail", ListIssuesData.class, String.class);
        /**
         * The meta-property for the {@code assigneeId} property.
         */
        private final MetaProperty<Long> assigneeId = DirectMetaProperty.ofReadWrite(
                this, "assigneeId", ListIssuesData.class, Long.TYPE);
        /**
        ...
        protected MetaProperty<?> metaPropertyGet(String propertyName) {
            switch (propertyName.hashCode()) {
                ...
                case -399756073:  // creationTimeStamp
                    return creationTimeStamp;
                case -1027172595:  // assigneeEmail
                    return assigneeEmail;
                case 1026023242:  // assigneeId
                    return assigneeId;
         ...
         * @return the meta-property, not null
         */
        public final MetaProperty<String> assigneeEmail() {
            return assigneeEmail;
        }
         ...
         * @return the meta-property, not null
         */
        public final MetaProperty<Long> assigneeId() {
            return assigneeId;
        }
        ...
        protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
            switch (propertyName.hashCode()) {
                ...
                case -1027172595:  // assigneeEmail
                    return ((ListIssuesData) bean).getAssigneeEmail();
                case 1026023242:  // assigneeId
                    return ((ListIssuesData) bean).getAssigneeId();
                case 950398559:  // comment
        ...
        protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
            switch (propertyName.hashCode()) {
                ...
                case -399756073:  // creationTimeStamp
                    ...
                    return;
                case -1027172595:  // assigneeEmail
                    ((ListIssuesData) bean).setAssigneeEmail((String) newValue);
                    return;
                case 1026023242:  // assigneeId
                    ((ListIssuesData) bean).setAssigneeId((Long) newValue);
                    return;
                case 950398559:  // comment
