...
gulp.task('aggregateJs', function() {
	return gulp.src([
			...
			'src/main/resources/src/js/modules/settings/personal/PersonalService.js',
			'src/main/resources/src/js/modules/settings/personal/PersonalController.js',
			...
			'src/main/resources/src/js/modules/settings/projectmanagement/ProjectManagementService.js',
			'src/main/resources/src/js/modules/settings/projectmanagement/ProjectManagementController.js',
